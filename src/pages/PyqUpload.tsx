    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            <FileUp className="text-amber-400" /> Upload PYQ Paper PDF (Free Section)
          </h1>
          <p className="text-sm text-neutral-400 mt-1">
            Auto-extract questions, edit options, set correct answer keys, and publish to the free PYQ section.
          </p>
        </div>
      </div>
      ...
      {publishSuccess && (
        <div className="p-6 bg-emerald-500/10 border border-emerald-500/30 rounded-xl text-emerald-400 text-center space-y-3">
          ...
          <h2 className="text-xl font-bold">PYQ Paper Successfully Published!</h2>
          <p className="text-sm text-neutral-300">
            This paper is now published in the Free PYQ Section for students to practice anytime.
          </p>
          <button
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between bg-neutral-800/50 border border-white/10 p-4 rounded-xl">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <Send size={16} />
                {isPublishing ? 'Publishing...' : 'Approve & Publish to PYQ Section'}
              </button>
            </div>
          </div>
